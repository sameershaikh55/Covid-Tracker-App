...
function App() {
	// for web-animation in the page
	const { ref } = useWebAnimations({ ...fadeInDownBig });
	...
	const lazyLoading = (
		<CircularProgress style={{ color: "rgba(0,0,0,0.6)", zoom: "0.6" }} />
	);

	return (
		<div ref={ref} className="page_container">
					...
					<FormControl>
						...
						>
							...
							{dropDownList.map((preData) => {
								return (
									<MenuItem value={preData.countryInfo.iso2}>
										{preData.country}
									</MenuItem>
								);
							})}
			...
			<div className="states_container">
				<div className="fcolumn">
					{loading ? (
						<div className="states">
							<div className="card_root">
								<div
									className="stats_cards"
									style={{
										borderBottom: "14px solid rgba(0, 0, 255, 0.6)",
							...
							<div className="card_root">
								<div
									className="stats_cards"
									style={{
										borderBottom: "14px solid rgba(0, 255, 0, 0.6)",
							...
							<div className="card_root">
								<div
									className="stats_cards"
									style={{
										borderBottom: "14px solid rgba(255, 0, 0, 0.6)",
								...
								>
									<div className="card">
										...
										>
											<CountUp
												isCounting
												end={dropDownChange.todayRecovered}
												duration={4}
												thousandsSeparator=","
											/>
										</Typography>
								...
								>
									<div className="card">
										...
										>
											<CountUp
												isCounting
												end={dropDownChange.todayDeaths}
												duration={4}
												thousandsSeparator=","
											/>
										</Typography>
					...
					<div className="graph_two">
						<GraphTwo
							confirmed={dropDownChange.cases}
